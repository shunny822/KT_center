...
pluralCaseList.push( {plural: "lossreports/lossReports", pascal: "LossreportLossReport"} )

pluralCaseList.push( {plural: "mylossinfos/lossInfoManagements", pascal: "MylossinfoLossInfoManagement"} )

pluralCaseList.push( {plural: "admins/serviceManagements", pascal: "AdminServiceManagement"} )

pluralCaseList.push( {plural: "alarms/alarmManagements", pascal: "AlarmAlarmManagement"} )
