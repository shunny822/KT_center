        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="lossInfoManagements"
                        to="/mylossinfos/lossInfoManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="lossInformations"
                        to="/mylossinfos/lossInformations"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="alarmManagements"
                        to="/alarms/alarmManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                key: 'lossReports', 
                route: '/lossreports/lossReports',
                ImageUrl: '',
            },
            { 
                title: '휴대폰분실정보관리', 
                description: 'LossInfoManagement을 관리하는 화면입니다.', 
                key: 'lossInfoManagements', 
                route: '/mylossinfos/lossInfoManagements',
                ImageUrl: '',
            },
            { 
                title: '서비스관리', 
                description: 'ServiceManagement을 관리하는 화면입니다.', 
                key: 'serviceManagements', 
                route: '/admins/serviceManagements',
                ImageUrl: '',
            },
            { 
                title: '알림관리', 
                description: 'AlarmManagement을 관리하는 화면입니다.', 
                key: 'alarmManagements', 
                route: '/alarms/alarmManagements',
                ImageUrl: '',
            },
            { 
                title: '휴대폰분실정보조회', 
                description: 'LossInformation을 관리하는 화면입니다.', 
                key: 'lossInformations', 
                route: '/mylossinfos/lossInformations',
                ImageUrl: '',
            },
